...
HD_PWD='C:/Users/karan/Documents/GitHub/ImageProcessor/ImageConvolutionUnit/ImageConvolutionUnit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log line_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source line_buffer.tcl
