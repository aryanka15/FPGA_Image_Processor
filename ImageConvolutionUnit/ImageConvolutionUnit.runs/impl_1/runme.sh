...
HD_PWD='C:/Users/karan/Documents/GitHub/ImageProcessor/ImageConvolutionUnit/ImageConvolutionUnit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log line_buffer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source line_buffer.tcl -notrace
