...
REM
REM Generated by Vivado on Thu Nov 27 18:31:51 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_line_buffer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_line_buffer_vlog.prj -log xvlog.log
