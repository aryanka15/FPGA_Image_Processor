...
REM
REM Generated by Vivado on Thu Nov 27 20:27:53 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_mac_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mac_vlog.prj -log xvlog.log
